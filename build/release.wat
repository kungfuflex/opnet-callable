(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34624))
 (memory $0 1)
 ...
 (data $17 (i32.const 1760) "\17\00\00\00 \00\00\00 \00\00\00 ")
 (data $17.1 (i32.const 1784) "\02\01\00\00A\00\00\00\00\00\00\00\02A\00\00\02\t\00\00\00\00\00\00 \00\00\00\00\00\00\00\02A")
 (data $17.2 (i32.const 1832) "B\00\00\00\02A\00\00\00\00\00\00 ")
 ...
 (func $~start
  ...
  i32.sub
  global.set $~lib/memory/__stack_pointer
  block $__inlined_func$start:~lib/@btc-vision/btc-runtime/runtime/universal/ABIRegistry$1
   block $folding-inner0
    global.get $~lib/memory/__stack_pointer
    i32.const 1856
    i32.lt_s
    ...
    br $__inlined_func$start:~lib/@btc-vision/btc-runtime/runtime/universal/ABIRegistry$1
   end
   i32.const 34656
   i32.const 34704
   i32.const 1
