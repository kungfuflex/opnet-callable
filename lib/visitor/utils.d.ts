import { DecoratorNode, IdentifierExpression, DeclarationStatement, Source, Node, Program, ClassDeclaration, TypeNode, InterfaceDeclaration, FunctionDeclaration, TypeName, DiagnosticCategory, DiagnosticEmitter, Range, util } from "assemblyscript";
export declare function decorates(node: DecoratorNode, name: string): boolean;
export declare function decoratorName(node: DecoratorNode): string;
